...
public class LFITabFactory implements IMessageEditorTabFactory{
    ...
    public LFITabFactory(IBurpExtenderCallbacks callbacks) {
        ...
        public void setMessage(byte[] content, boolean isRequest)
        {
            if (content == null)
            {
                ...
                for(int i=0; i < params.size(); i++) {
                	...
                	IParameter newParam = helpers.buildParameter(param.getName(), "../../../../../../../etc/passwd", paramType);
