...
public class SSRFTabFactory implements IMessageEditorTabFactory{
        ...
        public void setMessage(byte[] content, boolean isRequest)
        {
            if (content == null)
            {
                ...
                for(int i=0; i < params.size(); i++) {
                	...
                	IParameter newParam = helpers.buildParameter(param.getName(), "http://scanme.nmap.org:22", paramType);
