...
public class SSTITabFactory implements IMessageEditorTabFactory{
    ...
    public SSTITabFactory(IBurpExtenderCallbacks callbacks) {
        ...
        public void setMessage(byte[] content, boolean isRequest)
        {
            if (content == null)
            {
                ...
                for(int i=0; i < params.size(); i++) {
                	...
                	IParameter newParam = helpers.buildParameter(param.getName(), "{{191*7}}", paramType);
